// lib/features/home/widgets/learning_modes.dart
import 'package:flutter/material.dart';

import '../home/ui/main_menu_page.dart';

class LearningModes extends StatefulWidget {
  final String? userId;

  const LearningModes({super.key, required this.userId});
...
class _LearningModesState extends State<LearningModes> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSelectButton(widget.userId, accentColor),
        ],
      ),
    );
  }
  ...
  Widget _buildSelectButton(userId, Color accentColor) {
    return Padding(
        ...
        child: OutlinedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => MainMenuPage(userId: userId),
              ),
            );
          },
