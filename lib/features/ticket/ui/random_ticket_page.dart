// lib/features/ticket/ui/random_ticket_page.dart
...
class RandomTicketPage extends StatefulWidget {
  const RandomTicketPage({super.key});
...
class _RandomTicketPageState extends State<RandomTicketPage> {
  ...
  Future<void> _loadQuestions() async {
    setState(() {
      _questionsFuture = _client.getTicketRandom().then((list) =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Случайный билет')),
